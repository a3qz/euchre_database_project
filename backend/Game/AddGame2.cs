...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log)
{
    ...
    if (teamnumber >2 || teamnumber <1 || partner1score > 14 ||partner2score > 14){
        req.CreateResponse(HttpStatusCode.BadRequest, "Invalid values");
    }
    ...
    {
        conn.Open();
        var text = $"INSERT INTO Partner VALUES('{gameid}', '{partner1netid}', '{partner2netid}',{partner1score}, {partner2score}, {teamnumber});";
